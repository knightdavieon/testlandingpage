...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link" style="color:black" href="ReactorHall_About.html">About</a></li>
                        <li class="nav-item dropdown">
                          <a class="nav-link dropdown-toggle" style="color:black" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Tools
                          </a>
                          <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="ReactorHall_Tool_alarmpanel.html">Alarm Panels</a></li>
                            <li><a class="dropdown-item" href="ReactorHall_Tool_backuppowertool.html">BackUp Power Systems</a></li>
                            <li><a class="dropdown-item" href="ReactorHall_Tool_hmitool.html">Human Machine Interface</a></li>
                            <li><a class="dropdown-item" href="ReactorHall_Tool_radiationinstrumenttool.html">Radiation Monitoring Instruments</a></li>
                            <li><a class="dropdown-item" href="ReactorHall_Tool_reactorcontrol.html">Reactor Control Panel</a></li>
                            <li><a class="dropdown-item" href="ReactorHall_Tool_turbinecontrol.html">Turbine Control Panel</a></li>
                        </ul>
                        </li>
                        ...
                        <li class="nav-item"><a class="nav-link" style="color:black" href="ReactorHall_People.html">People</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Welcome to <strong>Reactor Hall</strong></h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5 border border-primary-subtle rounded-5">Contains the nuclear reactor and associated systems.</p>
                        <a class="btn btn-primary btn-xl" href="#About">Find Out More</i></a>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-light btn-xl" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                            View</a>
                              ...
                              <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                                ...
                                <div class="offcanvas-body">
                                  <div>
                                    Choose the document you want view
                                  </div>
                ...
                <div class="col">
                    ...
                    <img src="../../assets/img/portfolio/fullsize/Video1.jpg" class="card-img-top img-fluid" alt="Video Thumbnail">
                        <div class="card-body">
                            ...
                            <a class="btn btn-light btn-xl" href="#videoModal1">Watch Video</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div id="videoModal1" class="modal">
                    <div class="modal-content">
                        ...
                        <a href="#videoModal2" class="next">Next &raquo;</a>
                    </div>
                </div>
                <div id="videoModal2" class="modal">
                    <div class="modal-content">
                        ...
                        <a href="#videoModal3" class="next">Next &raquo;</a>
                    </div>
                </div>
                <div id="videoModal3" class="modal">
                    <div class="modal-content">
                        ...
                        <a href="#videoModal4" class="next">Next &raquo;</a>
                    </div>
                </div>
                <div id="videoModal4" class="modal">
                    <div class="modal-content">
                        ...
                        <a href="#videoModal1" class="next">Next &raquo;</a>
                    </div>
                </div>
            </div>
        </section>
        <!-- Safety-->
        <section class="page-section bg-info" id="Safety">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-10 text-center">
                        <h2 class="text-black mt-0">Safety Protocols</h2>
                        <hr class="divider divider-light" />
                        <p class="text-black-75 mb-4">Nuclear power plants adhere to rigorous safety protocols to ensure the safe generation of electricity and to protect both plant personnel and the surrounding environment. Here are some key safety protocols typically in place:</p>
                </div>
            </div>
            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Nuclear Regulatory Commission (NRC) (in the U.S.) or similar regulatory bodies in other countries set strict safety standards and conduct regular inspections.</p>
                        <p class="text-black-75 mb-4">•	Plants must comply with regulations concerning reactor design, operational procedures, and emergency preparedness.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        <strong>Reactor Design and Engineering</strong>
                    </button>
                  </h2>
                  <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Redundancy and Diversity: Critical systems have multiple backups and diverse methods to prevent failure. This includes redundant cooling systems, power supplies, and control systems.</p>
                        <p class="text-black-75 mb-4">•	Containment Structure: The reactor is housed within a robust containment structure designed to prevent the release of radiation in the event of an accident.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        <strong>Security Measureas</strong>
                      </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Physical Security: Robust physical security measures protect against unauthorized access and potential threats.</p>
                        <p class="text-black-75 mb-4">•	Cybersecurity: Protection of digital systems controlling plant operations to prevent cyberattacks.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                        <strong>Operational Protocols</strong>
                      </button>
                    </h2>
                    <div id="collapsefour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                          <p class="text-black-75 mb-4">•	Routine Maintenance: Regular checks and maintenance are performed to ensure all systems are functioning correctly.</p>
                          <p class="text-black-75 mb-4">• Operator Training: Personnel undergo rigorous training and simulations to prepare for normal operations and emergency scenarios.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
                        <strong>Radiation Protection</strong>
                      </button>
                    </h2>
                    <div id="collapsefive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Monitoring: Continuous monitoring of radiation levels within the plant and in the environment. Personal dosimeters track radiation exposure for plant workers.</p>
                        <p class="text-black-75 mb-4">•	Shielding: Use of physical barriers and shielding materials to reduce radiation exposure.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Emergency Plans: Comprehensive emergency response plans are in place, including evacuation procedures and coordination with local emergency services.</p>
                        <p class="text-black-75 mb-4">•	Drills and Exercises: Regular drills simulate various emergency scenarios to ensure preparedness and coordination among plant staff and external agencies.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseseven" aria-expanded="false" aria-controls="collapseseven">
                        <strong>Safety Culture</strong>
                      </button>
                    </h2>
                    <div id="collapseseven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Reporting and Transparency: Encouraging a culture where safety concerns can be reported without fear of reprisal. Transparent communication about safety issues is critical.</p>
                        <p class="text-black-75 mb-4">•	Continuous Improvement: Ongoing assessment and improvement of safety protocols based on incident reports, new research, and technological advancements.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseigth" aria-expanded="false" aria-controls="collapseigth">
                        <strong>Radiological Controls</strong>
                      </button>
                    </h2>
                    <div id="collapseigth" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	Waste Management: Safe handling, storage, and disposal of radioactive waste. This includes both spent fuel and low-level waste.</p>
                        <p class="text-black-75 mb-4">•	Decommissioning: Procedures for safely shutting down and decommissioning reactors when they reach the end of their operational life.</p>
                      </div>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse9" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="text-black-75 mb-4">•	The shop ensures that all maintenance and repair work adheres to the stringent safety and regulatory requirements specific to nuclear facilities.</p>
                        <p class="text-black-75 mb-4">•	This includes maintaining detailed records of all work performed and ensuring that all procedures comply with nuclear safety standards.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2023 - FissionFlux</div></div>
        </footer>
        <!-- Bootstrap core JS-->
